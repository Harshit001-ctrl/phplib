...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav flex-column sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="enquiry.php"><i class="fas fa-question"></i> Enquiry</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="showenquiry.php"><i class="fas fa-book-reader"></i> Show Enquiry</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admission.php"><i class="fas fa-book-reader"></i> Admission</a>
      </li>
      <li class="nav-item">
